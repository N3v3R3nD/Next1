...
# Add this block to fetch macroeconomic data
...
# Add this block to preprocess macroeconomic data
...
# Add this block to merge macroeconomic data with existing data
...
# Add this block to engineer features from macroeconomic data
...
# Add this line to drop original macroeconomic columns
...
logging.info('Feature Engineering Validation')
logging.info(data[['SMA', 'EMA', 'RSI', 'MACD', 'Upper', 'Lower', 'Cumulative_Returns', 'VWAP']].head())
logging.info(data[['SMA', 'EMA', 'RSI', 'MACD', 'Upper', 'Lower', 'Cumulative_Returns', 'VWAP']].tail())
...
# Insert data
db_operations.insert_data(cur, history, Y_train, train_predict, test_predict)
